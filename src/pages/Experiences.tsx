                    ...
                    >
                       ...
                       >
                          <p className="tracking-[0.12em] text-white/90 ">
                             ...
                             <br />
                             STATUS: {selectedExperience.status},<br />
                             {selectedExperience.company},<br />
                             {selectedExperience.duration}
                          </p>
                          <br />
                          <p
                             className="tracking-[0.12em] text-white/90 mt-6"
                          ...
                          {selectedExperience.technologies.map(
                             (tech, index) => (
                                <p
                                   key={index}
                                   className=" tracking-[0.12em] text-white/90 "
                                   style={{ fontSize: "10px", }}
                                >
                                   - {tech}
                                </p>
              ...
              >
                ...
                `,
                 ...
                 <div className="absolute inset-0 flex padding-20 justify-center z-10">
                    <div
                       className="text-center text-white/80 px-16 gap-4 flex justify-center items-center"
                       style={{
